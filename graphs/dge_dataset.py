...
class DgeDataSet:
    ...
    def find_pcs(_self, num_pcs=2, num_genes=None, choose_by='variance'):
        """
        :param numPCs:
        :param numGenes:
        :return:
        ...
        if num_genes:
            ...
            if choose_by == 'variance':
                genes = _self.vsd.var(axis=1).sort_values(ascending=False).head(num_genes).index
                df = _self.vsd.loc[genes].T
            else:
                pass
